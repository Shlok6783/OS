function getBotResponse(input) {
    ...
    if (input.includes("hello") || input.includes("hi")) {
    ...
    else if ((input.includes("read") && input.includes("preemtive")) || (input.includes("read") && input.includes("pps")) || (input.includes("read") && input.includes("priority"))) {
        ...
        return `<a class="click" style="font-size: 16px" href="/fcfs.html">FCFS</a>`;
    }
        ...
        return `<a class="click" style="font-size: 16px" href="/optimal.html">OPR</a>`;
    }
